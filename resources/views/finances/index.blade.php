...
<div class="grid grid-cols-3 gap-4 mb-7">
    <div class="bg-[#7c3a1e] rounded-xl p-5 text-white">
        ...
        <p class="text-[28px] font-bold leading-none">₱{{ number_format($totalCollections, 2) }}</p>
    </div>
    <div class="bg-white rounded-xl border border-[#ede7df] p-5">
        ...
        <p class="text-[28px] font-bold text-[#2d1a0e] leading-none">{{ $settledUnits }}/{{ $totalUnits }}</p>
    </div>
    <div class="bg-red-50 rounded-xl p-5">
        ...
        <p class="text-[28px] font-bold text-red-600 leading-none">₱{{ number_format($overdueAmount, 2) }}</p>
    </div>
</div>
